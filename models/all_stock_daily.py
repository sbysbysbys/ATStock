...
if __name__ == '__main__':
    ...
    datas = get_all_stock_data()
    if train_before_test:
        train_dataloader, test_dataloader = get_train_and_test_loader_all(datas)
    else:
        train_dataloader, test_dataloader = get_train_and_test_loader2_all(datas)
